          ...
          <div aria-label="card" className="px-5 md:py-3 py-8">
            ...
            <div className="flex items-start flex-col lg:flex-row">
              {user.profileLocation &&
                <a target='_blank' rel='noreferrer' href={'http://maps.google.com/?q=' + encodeURIComponent(user.profileLocation)} className="text-gray-600 dark:text-gray-400 focus:outline-none hover:text-indigo-700 focus:text-indigo-700 mt-4 lg:mt-0 ml-0 flex">
            ...
            <div className="flex items-center flex-wrap">
              {user.profileEmail &&
                <div className="py-2 px-1">
                  <a href={'mailto:' + user.profileEmail} target='_blank' rel='noreferrer' className="py-2 px-4 text-xs font-semibold leading-3 bg-blue-900 rounded hover:bg-indigo-600 focus:outline-none text-white">Email</a>
                </div>
              }
              {user.profilePhone &&
                <div className="py-2 px-1">
                  <a href={'tel:' + user.profilePhone} target='_blank' rel='noreferrer' className="py-2 px-4 text-xs font-semibold leading-3 bg-blue-900 rounded hover:bg-indigo-600 focus:outline-none text-white">Phone</a>
                </div>
              }
              {user.profileLinkedin &&
                <div className="py-2 px-1">
                  <a href={user.profileLinkedin} target='_blank' rel='noreferrer' className="py-2 px-4 text-xs font-semibold leading-3 bg-blue-900 rounded hover:bg-indigo-600 focus:outline-none text-white">Linkedin</a>
                </div>
              }
              {user.profileWebsite &&
                <div className="py-2 px-1">
                  <a href={user.profileWebsite} target='_blank' rel='noreferrer' className="py-2 px-4 text-xs font-semibold leading-3 bg-blue-900 rounded hover:bg-indigo-600 focus:outline-none text-white">Website</a>
                </div>
              }
              <div className="py-2 px-1">
